...
const OsuPlayerCard: React.FC<OsuPlayerCardProps> = ({
    ...
    const rarityColor =
        rarity === "Legendary"
            ...
            : rarity === "Ultra Rare"
            ? "bg-fuchsia-400 shadow-md shadow-fuchsia-400/50"
            : rarity === "Rare"
    ...
    return (
        <>
            ...
            <div
                className={`${rarityColor} text-black rounded-lg w-70 h-90 flex flex-col justify-start items-center transform transition-all duration-150 hover:scale-105 hover:shadow-lg`}
            >
